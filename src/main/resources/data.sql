...
CREATE TABLE tools {
    ...
    toolType varchar(20) NOT NULL FOREIGN KEY REFERENCES toolType(type),
    toolBrand varchar(30) NOT NULL FOREIGN KEY REFERENCES vendors(brand)
}

-- Create the charge table based on tool type
CREATE TABLE toolCharge {
    toolType varchar(20) NOT NULL PRIMARY KEY FOREIGN KEY REFERENCES toolType(type),
...
CREATE TABLE holiday {
    ...
    holidayMonth int,
    holidayDay int,
    dayFallsOn varchar(15) FOREIGN KEY REFERENCES days(dayOfWeek),
    frequency varchar(20) FOREIGN KEY REFERENCES frequency(freq)
}

-- Create Rental table for tracking when a tool is rented
CREATE TABLE rental {
    toolCode varchar(10) NOT NULL PRIMARY KEY FOREIGN KEY REFERENCES tools(toolCode),
    toolType varchar(20) NOT NULL PRIMARY KEY FOREIGN KEY REFERENCES toolType(type),
    toolBrand varchar(30) NOT NULL PRIMARY KEY FOREIGN KEY REFERENCES vendors(brand),
    rentalDays int NOT NULL,
    checkOutDate date NOT NULL,
    dueDate date,
    chargeDays int NOT NULL,
    due decimal(10,2) NOT NULL,
    dailyCharge decimal(5,2) NOT NULL FOREIGN KEY REFERENCES toolCharge(dailyCharge),
    chargeDays int NOT NULL,
...
INSERT INTO charge ( toolType, dailyCharge, weekDayCharge, weekEndCharge, holidayCharge)
